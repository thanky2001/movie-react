...
export default function EditUserModal(props) {
    ...
    useEffect(() => {
        formik.setValues({...infoEdit, maNhom: 'GP14',});
    }, [infoEdit]) // eslint-disable-line react-hooks/exhaustive-deps
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            if (values.maLoaiNguoiDung === '0' || (formik.values.soDt !== '' && !regex.test(formik.values.soDt))) {
                ...
                dispatch(updateUser(values, handleCloseAddModal))
            }
        },
    });
                ...
                <form onSubmit={formik.handleSubmit}>
                    <DialogContent>
                        ...
                        <TextField
                            ...
                            onChange={formik.handleChange}
                            error={(formik.touched.soDt && Boolean(validateEmail())) || (Boolean(formik.values.soDt) && Boolean(validateEmail()))}
                            helperText={(formik.touched.soDt && validateEmail()) || (Boolean(formik.values.soDt) && validateEmail())}
                        />
                        <TextField
